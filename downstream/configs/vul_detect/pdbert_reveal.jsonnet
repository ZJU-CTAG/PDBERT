local data_base_path = '../data/datasets/extrinsic/vul_detect/reveal/';
...
# -config configs/vul_detect/pdbert_reveal.jsonnet -task_name vul_detect/reveal -average binary
