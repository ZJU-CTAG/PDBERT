local data_base_path = '../data/datasets/extrinsic/vul_detect/devign/';
...
# -config configs/vul_detect/pdbert_devign.jsonnet -task_name vul_detect/devign -average binary
...

{
    dataset_reader: {
        ...
        func_code_field_key: "func",
        vul_label_field_key: "target",
  ...
  trainer: {
    ...
    validation_metric: "+BooleanAccuracy",
    optimizer: {
      type: "adam",
      lr: 1e-5
    },
